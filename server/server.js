...
app.use(helmet({
    contentSecurityPolicy: {
        directives: {
            ...
            scriptSrc: [
                "'self'",
                "'unsafe-inline'", // Needed for some legacy/inline scripts, try to minimize
            ...
            frameSrc: ["'self'", "https://www.youtube.com", "https://googleads.g.doubleclick.net", "https://tpc.googlesyndication.com"],
